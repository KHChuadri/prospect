...
EVENT_SYSTEM = (
    ...
    "set is_online=true for virtual events. Return the city the event is held "
    "in as city — the city name alone, such as Sydney or Seoul. If the page "
    "does not name a city, return null; do not infer one from a venue or "
    "building name.\n\n"
